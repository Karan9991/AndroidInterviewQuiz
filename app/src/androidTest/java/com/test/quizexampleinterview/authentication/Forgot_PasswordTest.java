...
public class Forgot_PasswordTest {
    ...
    public void view(){
        ...
        onView(withId(R.id.editTextforpassemail)).perform(typeText("someString"), closeSoftKeyboard());
    ...
    public void edittext(){
        ...
        onView(withId(R.id.editTextforpassemail)).check(matches(isFocusable()));
    }
}